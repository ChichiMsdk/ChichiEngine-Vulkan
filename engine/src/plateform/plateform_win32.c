...
{
	plat_state->internal_state = (void *)malloc(sizeof(internal_state));
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "chichi_window_class", application_name,
...
void platform_get_required_extension_name(const char ***names_darray)
{
